...
static const char *fonts[] = { "MonocraftNerdFont:size=20:antialias=false:autohint=false" };
/*static const char *fonts[] = { "Inconsolata:size=22:antialias=false:autohint=true" }; */
